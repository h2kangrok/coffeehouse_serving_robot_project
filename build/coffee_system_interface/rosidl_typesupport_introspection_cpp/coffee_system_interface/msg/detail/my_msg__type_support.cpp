...
{
  new (message_memory) coffee_system_interface::msg::MyMsg(_init);
}

void MyMsg_fini_function(void * message_memory)
{
  auto typed_message = static_cast<coffee_system_interface::msg::MyMsg *>(message_memory);
  typed_message->~MyMsg();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember MyMsg_message_member_array[1] = {
  {
    ...
    offsetof(coffee_system_interface::msg::MyMsg, cook),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers MyMsg_message_members = {
  ...
  "MyMsg",  // message name
  1,  // number of fields
  sizeof(coffee_system_interface::msg::MyMsg),
...
{
  return &::coffee_system_interface::msg::rosidl_typesupport_introspection_cpp::MyMsg_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, coffee_system_interface, msg, MyMsg)() {
  return &::coffee_system_interface::msg::rosidl_typesupport_introspection_cpp::MyMsg_message_type_support_handle;
}

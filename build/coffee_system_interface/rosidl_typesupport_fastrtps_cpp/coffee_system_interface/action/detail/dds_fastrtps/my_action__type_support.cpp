...
#include "coffee_system_interface/action/detail/my_action__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const coffee_system_interface::action::MyAction_Goal & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  coffee_system_interface::action::MyAction_Goal & ros_message)
{
  // Member: table_num
  cdr >> ros_message.table_num;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = coffee_system_interface::action::MyAction_Goal;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const coffee_system_interface::action::MyAction_Goal *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<coffee_system_interface::action::MyAction_Goal *>(
    untyped_ros_message);
...
{
  return &coffee_system_interface::action::typesupport_fastrtps_cpp::_MyAction_Goal__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, coffee_system_interface, action, MyAction_Goal)() {
  return &coffee_system_interface::action::typesupport_fastrtps_cpp::_MyAction_Goal__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_coffee_system_interface
cdr_serialize(
  const coffee_system_interface::action::MyAction_Result & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  coffee_system_interface::action::MyAction_Result & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = coffee_system_interface::action::MyAction_Result;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const coffee_system_interface::action::MyAction_Result *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<coffee_system_interface::action::MyAction_Result *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &coffee_system_interface::action::typesupport_fastrtps_cpp::_MyAction_Result__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, coffee_system_interface, action, MyAction_Result)() {
  return &coffee_system_interface::action::typesupport_fastrtps_cpp::_MyAction_Result__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_coffee_system_interface
cdr_serialize(
  const coffee_system_interface::action::MyAction_Feedback & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  coffee_system_interface::action::MyAction_Feedback & ros_message)
{
  // Member: current_state
  cdr >> ros_message.current_state;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = coffee_system_interface::action::MyAction_Feedback;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const coffee_system_interface::action::MyAction_Feedback *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<coffee_system_interface::action::MyAction_Feedback *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &coffee_system_interface::action::typesupport_fastrtps_cpp::_MyAction_Feedback__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, coffee_system_interface, action, MyAction_Feedback)() {
  return &coffee_system_interface::action::typesupport_fastrtps_cpp::_MyAction_Feedback__handle;
}
...
// functions for coffee_system_interface::action::MyAction_Goal already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_coffee_system_interface
cdr_serialize(
  const coffee_system_interface::action::MyAction_SendGoal_Request & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ...
    cdr);
  // Member: goal
  coffee_system_interface::action::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.goal,
    cdr);
  return true;
}
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  coffee_system_interface::action::MyAction_SendGoal_Request & ros_message)
{
  // Member: goal_id
  ...
  // Member: goal
  coffee_system_interface::action::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  current_alignment +=
    coffee_system_interface::action::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: goal
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        coffee_system_interface::action::typesupport_fastrtps_cpp::max_serialized_size_MyAction_Goal(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = coffee_system_interface::action::MyAction_SendGoal_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const coffee_system_interface::action::MyAction_SendGoal_Request *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<coffee_system_interface::action::MyAction_SendGoal_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &coffee_system_interface::action::typesupport_fastrtps_cpp::_MyAction_SendGoal_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, coffee_system_interface, action, MyAction_SendGoal_Request)() {
  return &coffee_system_interface::action::typesupport_fastrtps_cpp::_MyAction_SendGoal_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_coffee_system_interface
cdr_serialize(
  const coffee_system_interface::action::MyAction_SendGoal_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: accepted
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  coffee_system_interface::action::MyAction_SendGoal_Response & ros_message)
{
  // Member: accepted
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = coffee_system_interface::action::MyAction_SendGoal_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const coffee_system_interface::action::MyAction_SendGoal_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<coffee_system_interface::action::MyAction_SendGoal_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &coffee_system_interface::action::typesupport_fastrtps_cpp::_MyAction_SendGoal_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, coffee_system_interface, action, MyAction_SendGoal_Response)() {
  return &coffee_system_interface::action::typesupport_fastrtps_cpp::_MyAction_SendGoal_Response__handle;
}
...
{
  return &coffee_system_interface::action::typesupport_fastrtps_cpp::_MyAction_SendGoal__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, coffee_system_interface, action, MyAction_SendGoal)() {
  return &coffee_system_interface::action::typesupport_fastrtps_cpp::_MyAction_SendGoal__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_coffee_system_interface
cdr_serialize(
  const coffee_system_interface::action::MyAction_GetResult_Request & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  coffee_system_interface::action::MyAction_GetResult_Request & ros_message)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.goal_id);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = coffee_system_interface::action::MyAction_GetResult_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const coffee_system_interface::action::MyAction_GetResult_Request *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<coffee_system_interface::action::MyAction_GetResult_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &coffee_system_interface::action::typesupport_fastrtps_cpp::_MyAction_GetResult_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, coffee_system_interface, action, MyAction_GetResult_Request)() {
  return &coffee_system_interface::action::typesupport_fastrtps_cpp::_MyAction_GetResult_Request__handle;
}
...
// forward declaration of message dependencies and their conversion functions
// functions for coffee_system_interface::action::MyAction_Result already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_coffee_system_interface
cdr_serialize(
  const coffee_system_interface::action::MyAction_GetResult_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: status
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  coffee_system_interface::action::MyAction_GetResult_Response & ros_message)
{
  // Member: status
  cdr >> ros_message.status;
  ...
  size_t current_alignment)
{
  ...
  // Member: result
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        coffee_system_interface::action::typesupport_fastrtps_cpp::max_serialized_size_MyAction_Result(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = coffee_system_interface::action::MyAction_GetResult_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const coffee_system_interface::action::MyAction_GetResult_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<coffee_system_interface::action::MyAction_GetResult_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &coffee_system_interface::action::typesupport_fastrtps_cpp::_MyAction_GetResult_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, coffee_system_interface, action, MyAction_GetResult_Response)() {
  return &coffee_system_interface::action::typesupport_fastrtps_cpp::_MyAction_GetResult_Response__handle;
}
...
{
  return &coffee_system_interface::action::typesupport_fastrtps_cpp::_MyAction_GetResult__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, coffee_system_interface, action, MyAction_GetResult)() {
  return &coffee_system_interface::action::typesupport_fastrtps_cpp::_MyAction_GetResult__handle;
}
...
// functions for coffee_system_interface::action::MyAction_Feedback already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_coffee_system_interface
cdr_serialize(
  const coffee_system_interface::action::MyAction_FeedbackMessage & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  coffee_system_interface::action::MyAction_FeedbackMessage & ros_message)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.goal_id);
  ...
  size_t current_alignment)
{
  ...
  // Member: feedback
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        coffee_system_interface::action::typesupport_fastrtps_cpp::max_serialized_size_MyAction_Feedback(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = coffee_system_interface::action::MyAction_FeedbackMessage;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const coffee_system_interface::action::MyAction_FeedbackMessage *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<coffee_system_interface::action::MyAction_FeedbackMessage *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &coffee_system_interface::action::typesupport_fastrtps_cpp::_MyAction_FeedbackMessage__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, coffee_system_interface, action, MyAction_FeedbackMessage)() {
  return &coffee_system_interface::action::typesupport_fastrtps_cpp::_MyAction_FeedbackMessage__handle;
}

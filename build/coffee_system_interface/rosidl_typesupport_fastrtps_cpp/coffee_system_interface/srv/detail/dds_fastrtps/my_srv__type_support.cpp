...
#include "coffee_system_interface/srv/detail/my_srv__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const coffee_system_interface::srv::MySrv_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  coffee_system_interface::srv::MySrv_Request & ros_message)
{
  // Member: table_num
  cdr >> ros_message.table_num;
  ...
  size_t current_alignment)
{
  ...
  // Member: items
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += padding +
        eprosima::fastcdr::Cdr::alignment(current_alignment, padding) +
        (ros_message.items[index].size() + 1);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = coffee_system_interface::srv::MySrv_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const coffee_system_interface::srv::MySrv_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<coffee_system_interface::srv::MySrv_Request *>(
    untyped_ros_message);
...
{
  return &coffee_system_interface::srv::typesupport_fastrtps_cpp::_MySrv_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, coffee_system_interface, srv, MySrv_Request)() {
  return &coffee_system_interface::srv::typesupport_fastrtps_cpp::_MySrv_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_coffee_system_interface
cdr_serialize(
  const coffee_system_interface::srv::MySrv_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  coffee_system_interface::srv::MySrv_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = coffee_system_interface::srv::MySrv_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const coffee_system_interface::srv::MySrv_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<coffee_system_interface::srv::MySrv_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &coffee_system_interface::srv::typesupport_fastrtps_cpp::_MySrv_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, coffee_system_interface, srv, MySrv_Response)() {
  return &coffee_system_interface::srv::typesupport_fastrtps_cpp::_MySrv_Response__handle;
}
...
{
  return &coffee_system_interface::srv::typesupport_fastrtps_cpp::_MySrv__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, coffee_system_interface, srv, MySrv)() {
  return &coffee_system_interface::srv::typesupport_fastrtps_cpp::_MySrv__handle;
}

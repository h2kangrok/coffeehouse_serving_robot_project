...
#include "coffee_system_interface/msg/detail/my_msg__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = coffee_system_interface::msg::MyMsg;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const coffee_system_interface::msg::MyMsg *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<coffee_system_interface::msg::MyMsg *>(
    untyped_ros_message);
...
{
  return &coffee_system_interface::msg::typesupport_fastrtps_cpp::_MyMsg__handle;
}
